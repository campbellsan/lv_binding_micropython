...
class HandClass():
    ...
    def calc(self, obj):
        ...
        print("Area: x1-" + str(area.x1) + ", y1-" + str(area.y1) + ", x2-" + str(area.x2) + ", y2-" + str(area.y2))
        obj.valid = True
...
class Hand():
    ...
    def get_class():
        # Return the internal LVGL class
        return Hand.cls.get_class()

    def __new__(cls, parent):
        # Return a new lv object instead of Hand,
        # but first bind the LVGL object with HandWrapper
        wrapper = cls.HandWrapper(parent)
    ...
    class HandWrapper():
        ...
        def __init__(self, parent):
            ...
            self.lv_obj = Hand.cls.create(parent)
...
class HandTheme(lv.theme_t):
    ...
    def __init__(self):
        super().__init__()
        self.custom_style = HandTheme.Style()
        self.custom_pressed_style = HandTheme.PressedStyle()
    ...
    def apply(self, theme, obj):
        # Apply this theme on Hand class
        if obj.get_class() == Hand.get_class():
